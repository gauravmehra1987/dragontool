...
<figure id="car" class="model-image">
	...
	<figcaption>
		...
		<div class="car-layout top">
			...
			<h2>MINI COUNTRYMAN COOPER SD ALL4</h2>

			<a href="#" class="button switch-bg">Call to action</a>
			...
			<table id="payment-plan">
				...
				<tbody>
					...
					<tr>
						...
						<td>Retailer deposit contribution</td>
						<td>Value</td>

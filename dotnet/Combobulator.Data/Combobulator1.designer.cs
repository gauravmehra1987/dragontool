...
namespace Combobulator.Data
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="MINI_FS_QA")]
    ...
    partial void OnDealerDiscountChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Car_Finance", Storage="_Cars", ThisKey="NewCarId", OtherKey="Id", IsForeignKey=true)]
		public Cars Cars
		{
			get
			{
	...
	public partial class GetCarsResult
	{
        ...
        [global::System.Data.Linq.Mapping.ColumnAttribute(Storage = "_Disclaimer", DbType = "VarChar(500) NOT NULL", CanBeNull = false)]
        public string Disclaimer
        {
            get
            {
